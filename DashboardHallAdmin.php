...
<body class="bg-gray-100">
    ...
    <nav class="bg-gray-800 text-white py-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <ul class="flex space-x-6">
                ...
                <li><a href="ManageApplications.php" class="hover:text-university-yellow nav-link">Manage Applications</a></li>
    ...
    <section class="bg-white text-gray-800 py-20">
        <div class="container mx-auto text-center">
            ...
            <div class="mt-8">
                <img src="C:\xampp\htdocs\NstuAcademia\nstu_image.jpeg" alt="University Campus" class="mx-auto w-full sm:w-3/4 md:w-1/2 rounded-lg shadow-lg">
            </div>
        </div>
    </section>
