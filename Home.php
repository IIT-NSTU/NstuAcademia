...
<main class="container mx-auto mt-10 px-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col md:flex-row justify-between items-center mb-10">
        <div class="md:w-1/2 space-y-4">
            ...
            <a href="#" class="bg-university-blue text-white px-4 py-2 rounded-lg hover:bg-gray-800">Get Started</a>
        </div>
        <div class="md:w-1/2 mt-6 md:mt-0 flex justify-center">
            <img src="images/campus_image.jpg" alt="Campus Image" class="rounded-lg shadow-lg w-full max-w-md">
        </div>
    </div>
